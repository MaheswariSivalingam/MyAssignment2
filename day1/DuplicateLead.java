...
public class DuplicateLead {
	...
	public static void main(String[] args) {
        ...
        driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Maheswari");
        ...
        driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("maheswarisiva1301@gmail.com");
        ...
        driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Mahes");
        driver.findElement(By.name("submitButton")).click();
